...
\begin{table}[!ht]
    ...
    \small
	\begin{tabular}{p{0.175\linewidth}cccp{0.325\linewidth}c}
		\toprule
		\multicolumn{1}{c}{Author(s)}&Year&\multicolumn{1}{c}{Method}&Citations&\multicolumn{1}{c}{Focus of study}&Source\\
		\midrule
		Shaikh \gls{etal} &2021 & \gls{tlr} & 44 & Exploring the potential of acoustic signal analysis in facilitating machine fault diagnosis.&\cite{Shaikh2021}\\
		\hline
		Qurthobi \gls{etal} &2022& \gls{slr} & 52 & \Gls{sota} mechanical failure detection using acoustic methods.&\cite{Qurthobi2022}\\
		\hline
		\dots& \dots & \dots & \dots\\
		\bottomrule
	\end{tabular}
